...
/// <summary>
/// Represents the Ducati classic bike class.
/// </summary>
...
internal sealed class DucatiClassicBike(string name,
                                        Brand brand,
                                        int displacement,
                                        Color color,
                                        int wetWeight,
                                        ...
                                        bool absSupport) : Motorbike
{
    ...
    public override void ShippingMethod()
        => Console.WriteLine($"Shipping Method: Shipping {Brand} {Name} by road.");
}
